...
import ru.ravel.ultunnel.compose.component.qr.QRSDialog
import ru.ravel.ultunnel.compose.component.qr.QRScanSheet
...
import ru.ravel.ultunnel.ktx.shareProfileAsJson
import java.io.File
...
private fun ProfileActionRow(
	...
	// Если профиль не Remote — вообще не показываем строку действий (убирает карандаш/шаринг полностью)
