...
import ru.ravel.ultunnel.databinding.ActivityQrScanBinding
...
class QRScanActivity : AbstractActivity<ActivityQrScanBinding>() {
	...
	private fun importRemoteProfileFromString(uriString: String) {
		...
		if (uri.scheme != "ultunnel" || uri.host != "import-remote-profile") error("Not a valid sing-box remote profile URI")
